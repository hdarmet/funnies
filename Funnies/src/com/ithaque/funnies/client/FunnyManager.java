...
public class FunnyManager extends CircusManager {
	...
	public void init() {
		...
		circus.enterRing(new TileFunny.HHexFunny("t1", "hexagon.png", "rhexagon.png", 26.0f, 0.0f, 0.0f));
		circus.enterRing(new TileFunny.HHexFunny("t2", "hexagon.png", "rhexagon.png", 26.0f, -3*dx, -dy));
		circus.enterRing(new TileFunny.HHexFunny("t3", "hexagon.png", "rhexagon.png", 26.0f, 0, -dy*2));
		circus.enterRing(new TileFunny.HHexFunny("t4", "hexagon.png", "rhexagon.png", 26.0f, 3*dx, -dy));
		circus.enterRing(new TileFunny.HHexFunny("t5", "hexagon.png", "rhexagon.png", 26.0f, 3*dx, dy));
		circus.enterRing(new TileFunny.HHexFunny("t6", "hexagon.png", "rhexagon.png", 26.0f, 0, dy*2));
		circus.enterRing(new TileFunny.HHexFunny("t7", "hexagon.png", "rhexagon.png", 26.0f, -3*dx, dy));
